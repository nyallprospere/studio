...
import { Shield, Users, BarChart3, Landmark, Map, FilePlus } from 'lucide-react';
...
const adminSections = [
    ...
    { title: 'Manage Constituencies', href: '/admin/constituencies', icon: FilePlus },
    { title: 'Manage Map', href: '/admin/map', icon: Map },
];
