...
export function InteractiveMap2({ constituencies, selectedConstituencyId, election, onConstituencyClick, onLeaningChange, onPredictionChange, electionResults, previousElectionResults, previousElection, partyLogos, isMakeYourOwn }: InteractiveMap2Props) {
